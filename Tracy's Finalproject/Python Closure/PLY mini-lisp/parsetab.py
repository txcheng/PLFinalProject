...
_lr_productions = [
  ...
  ('atom -> SIMB','atom',1,'p_atom_simbol','yacc.py',193),
  ('atom -> bool','atom',1,'p_atom_bool','yacc.py',197),
  ('atom -> NUM','atom',1,'p_atom_num','yacc.py',201),
  ('atom -> TEXT','atom',1,'p_atom_word','yacc.py',205),
  ('atom -> <empty>','atom',0,'p_atom_empty','yacc.py',209),
  ('bool -> TRUE','bool',1,'p_true','yacc.py',213),
  ('bool -> FALSE','bool',1,'p_false','yacc.py',217),
  ('atom -> NIL','atom',1,'p_nil','yacc.py',221),
]
